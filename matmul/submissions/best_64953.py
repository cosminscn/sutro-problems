"""Load and independently verify the 64,953 16x16 matmul submission."""
...
EXPECTED_SCORE = 64953
EXPECTED_SHA256 = 'e4d210fc2c6a31bd3d363625eacc154847bc83c205eb0a65b658722c8a883e5c'
EXPECTED_OPERATIONS = {'copy': 1649, 'mul': 4096, 'add': 3840}
EXPECTED_READ_COSTS = {'copy': 21422, 'mul': 14300, 'add': 24796, 'output': 4435}
IR_PATH = Path(__file__).with_suffix(".ir")


def generate_best_64953():
    return IR_PATH.read_text(encoding="utf-8")


def verify():
    ir = generate_best_64953()
