"""Rebuild 64,448 with heterogeneous panel row groups and portable allocation."""
...
CAPTURE_THRESHOLD = 8
EXPECTED = {'captured_generator': (1177063, '6dca745d2e7fff3e23794dc28c6481fde140bb522922ab34c06d9e2c3cfb089a'),
 'dp_initial': (64476, '88bca3be93761060e23de4d10b0c0a0419e0ca513ada0154686da099110be3df'),
 'pair2_seed0_no_ties': (64448, 'e01319a1c15e676daa105e094513df78d6e4a85f1cf92656b1053175e96f1053'),
 'pair5_seed11_ties': (64448, '5cbf44a58ab45a28da2da90fdad48083d332daa57971da7ab5340225018be33b')}
EXPECTED_HISTORY_SHA256 = {'pair2_seed0_no_ties': 'c951137ae9376e2c186c35837e930894eff9fc8ef0c3d767788e1e55f8b9ac49',
 'pair5_seed11_ties': '4f53cda18c2baa0c0354bb5f9a3ecbe5ed12ab4d8e11ba873c2f11161202b945'}


def generate():
    """Literal seven-tile geometry, rotated contraction order and column snakes."""
    ops, outputs = [], {}
    next_value = 512
    ...
    panels = zip(reference.groups(COLUMN_WIDTHS), ROW_WIDTHS_BY_PANEL, CHUNKS_BY_PANEL,
                 K_OFFSETS_BY_PANEL, REVERSE_BY_PANEL)
    for columns, widths, chunk, offsets, reversals in panels:
        row_groups = reference.groups(widths)
...
def capture_b(p):
    """Retain first staged B[k,j] for columns 8..15; reload columns 6 and 7."""
...
def reproduce(output=None, manifest=None):
    ...
    ir = core.emit(p)
    assert ir.encode() == (HERE.parent / 'best_64448.ir').read_bytes(), 'Replay differs from submission'
    ...
    result = {'score': 64448, 'sha256': EXPECTED['pair5_seed11_ties'][1],
              ...
              'configuration': {'row_widths_by_panel': ROW_WIDTHS_BY_PANEL, 'column_widths': COLUMN_WIDTHS,
                                'chunks_by_panel': CHUNKS_BY_PANEL, 'k_offsets_by_panel': K_OFFSETS_BY_PANEL,
                                'reverse_by_panel': REVERSE_BY_PANEL, 'capture_threshold': CAPTURE_THRESHOLD},
    ...
    print('Portable generator replay is byte-identical to best_64448.ir.', flush=True)
    return result
