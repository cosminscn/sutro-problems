"""Load and independently verify the 64,456 16x16 matmul submission."""
...
EXPECTED_SCORE = 64456
EXPECTED_SHA256 = '729fbafe50f61e0553f1f3e5e87ec2a6e3d4bdbe0d7bbfefafe5998ba63f445f'
EXPECTED_OPERATIONS = {'copy': 1520, 'mul': 4096, 'add': 3840}
EXPECTED_READ_COSTS = {'copy': 19847, 'mul': 19352, 'add': 20770, 'output': 4487}
IR_PATH = Path(__file__).with_suffix('.ir')


def generate_best_64456():
    return IR_PATH.read_text(encoding='utf-8')


def verify():
    ir = generate_best_64456()
